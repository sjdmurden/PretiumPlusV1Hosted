...
namespace CSV_reader.Models
{
    public class ClaimsCalculationsModel
    {
        ...
        */
        ...
        public double COI_ContingentPerDay { get; set; }
        public double COI_ContingentFixedFigure { get; set; }
        ...
        public double FCTurnoverCOI { get; set; }
        public double FCTurnoverNonCOI { get; set; }
        ...
        public double ThreeY_ADPaid { get; set; }
        public double FiveY_ADPaid { get; set; }
        // F&T Paid
        ...
        public double ThreeY_FTPaid { get; set; }
        public double FiveY_FTPaid { get; set; }
        // TP PD Paid
